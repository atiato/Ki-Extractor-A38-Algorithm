...
public:
  ...
  //   unsigned char [7] intArray = gcnew unsigned char [7] {0xA0,0xA4,0x00,0x00,0x02,0x2F,0xE2};
	 ...
	 array<unsigned char>^ intArray = gcnew array<unsigned char>(24) {0xA0,0xA4,0x00,0x00,0x02,0x3F,0x00};

	 //select 6F 07

	 array<unsigned char>^ select = gcnew array<unsigned char>(24) {0xA0,0xA4,0x00,0x00,0x02,0x7F,0x20};
	
	 array<unsigned char>^ AuthComm = gcnew array<unsigned char>(24) {0xA0,0x88,0x00,0x00,0x10};

	 array<unsigned char>^ pinvarification = gcnew array<unsigned char>(24) {0xA0,0x20,0x00,0x01,0x08};
	
	array<unsigned char>^ pin = gcnew array<unsigned char>(24) {0x30,0x30,0x30,0x30,0xFF,0xFF,0xFF,0xFF};

	array<unsigned char>^ readSRES = gcnew array<unsigned char>(24) {0xA0,0xC0,0x00,0x00,0x0C};	
...
void A3A8_crack(/* in */ Byte1 rand[16], /* in */ Byte1 key[16],
